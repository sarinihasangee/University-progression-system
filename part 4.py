...
while True:
    ...
    if pass_credit == 120:
        ...
        # create a dictonary for progress
        progression_dict[student_id] = f"Progress - {pass_credit}, {defer_credit}, {fail_credit}"
    ...
    # Progress (module trailer) check 
        ...
        # create a dictonary for trailer
        progression_dict[student_id] = f"Progress (module trailer) - {pass_credit}, {defer_credit}, {fail_credit}"
    ...
    # Do not progress - module retriever check
        ...
        # create a dictonary for retriver
        progression_dict[student_id] = f"Module retriever - {pass_credit}, {defer_credit}, {fail_credit}"
    ...
    # Exclude check
        ...
        # create a dictonary for exclude
        progression_dict[student_id] = f"Exclude - {pass_credit}, {defer_credit}, {fail_credit}"
    ...
    if choice_lower == 'y':
        ...
        with open("output.txt", "w") as f:
            ...
            # Write the contents of progress_list
            f.write("Progress - ")
            for item in progress_list:
                f.write(str(item) + "\n")
                
            # Write the contents of trailer_list
            f.write("\nProgress (module trailer) - ")
            for item in trailer_list:
                f.write(str(item) + "\n")
                
            # Write the contents of retriever_list
            f.write("\nModule retriever - ")
            for item in retriever_list:
                f.write(str(item) + "\n")
                
            # Write the contents of exclude_list
            f.write("\nExclude - ")
